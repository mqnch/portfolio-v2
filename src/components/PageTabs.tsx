...
const scrollPanelClass =
  'scrollbar-hide scroll-smooth overscroll-y-contain overflow-y-auto max-h-[calc(100vh-10rem)] md:max-h-[calc(100vh-20rem)] [-webkit-overflow-scrolling:touch] pr-3 pb-32 md:pb-0';
